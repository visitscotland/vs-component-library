...
export default {
    ...
    title: 'Components/Deprecated/Tourism Info',
    tags: ['deprecated'],
};
...
const Template = (args) => ({
    ...
    template: `
        <div style="background: #940f2c17; padding: 1rem; border: 1px solid #940F2C; margin-bottom: 1rem;">
            ...
            See the <a href="https://visitscotland.atlassian.net/wiki/spaces/DE/pages/1353416810/Tourism+Info+deprecated">Component migration docs.</a> 
        </div>
