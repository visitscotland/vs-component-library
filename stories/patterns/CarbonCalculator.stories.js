...
const base = {
    ...
    labelsMap: {
        ...
        'page-3.question': 'How many hours will your journey take?',
        'page-4.question': 'How many hours will your journey take?',
        'page-5.question': 'How many hours will your journey take?',
        'page-6.question': 'How many hours will your journey take?',
        'page-7.question': 'How many days are you staying for?',
        'page-8.question': 'How would you describe your diet?',
        'page-8.option-1': 'Regular meat-eater',
        'page-8.option-2': 'Moderate meat-eater',
        'page-8.option-3': 'Infrequent meat-eater',
        'page-8.option-4': 'Pescatarian',
        'page-8.option-5': 'Vegetarian',
        'page-8.option-6': 'Vegan',
    },
};
