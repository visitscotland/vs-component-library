...
const base = {
    ...
    labelsMap: {
        ...
        comparison: 'That\'s the equivalent of xxx miles in a medium-sized electric car, which would take you from Edinburgh to London yyy times!',
        kilos: 'kilos',
        ...
        'page-1.option-7': 'Coach',
        'page-1.option-8': 'Ferry',
        'page-1.option-9': 'Campervan/Motorhome (Petrol)',
        'page-1.option-10': 'Camperval/Motorhome (Diesel)',
