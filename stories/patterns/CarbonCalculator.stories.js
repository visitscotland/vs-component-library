...
const base = {
    ...
    labelsMap: {
        ...
        comparison: '<p>That\'s the equivalent to travelling the West Highland line over the Glenfinnan Viaduct (like Harry Potter!) xxx times.</p><p>The West Highland Line runs from Glasgow to Mallaig for 162 miles. Each journey uses 9.29kg of CO₂e per person.</p>',
        ...
        perDayTarget: 5,
        perDaySuccess: 'Congratulations! With less than 5 kilos of CO₂e emitted per day on your trip, you\'re a carbon Unicorn.',
        topTip: 'Top Tip!',
        allTips: 'You can view all our sustainable travel tips <a href="#">here</a>. We\'ve got you covered!',
        soFar: 'Your calculation so far:',
        kgsOf: 'KGs of CO₂e',
        kgsPerDay: 'Thats equivalent to xxx KGs of CO₂e per day.',
        transport: 'Transport',
