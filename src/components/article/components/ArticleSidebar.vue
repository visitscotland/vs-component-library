<template>
    ...
    >
        <div
            v-if="$slots['vs-article-sidebar-img']
                && $slots['vs-article-sidebar-img']()"
            :class="$slots['vs-article-sidebar-quote']
                && $slots['vs-article-sidebar-quote']()
                ? 'pb-200' : ''"
        ...
        <div
            v-if="$slots['vs-article-sidebar-quote']
                && $slots['vs-article-sidebar-quote']()"
            :class="$slots['vs-article-sidebar-img']
                && $slots['vs-article-sidebar-img']()
                ? 'pt-0' : ''"
