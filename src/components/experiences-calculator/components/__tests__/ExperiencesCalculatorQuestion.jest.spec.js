...
import VsExperiencesCalculatorQuestion from '../ExperiencesCalculatorQuestion.vue';

jest.mock('@/utils/svg-context');

config.global.renderStubDefaultSlot = true;

const factoryMount = (propsData) => mount(VsExperiencesCalculatorQuestion, {
    propsData: {
...
describe('VsExperiencesCalculatorQuestion', () => {
    it('should render a div with the correct test attribute', () => {
        const wrapper = factoryMount();

        const Question = wrapper.find('[data-test=vs-experiences-calculator-question]');
