...
//             expect(wrapper
//              .findAll('[data-test="vs-main-map-wrapper__map-toggle-group"]')
//              .exists()).toBe(true);
//         });

//         it('should not show the toggle buttons when the `hideToggleButtons` prop is true',
//          async() => {
//             const wrapper = factoryShallowMount();
...
//     describe(':methods', () => {
//         it('should hide the side panel after the `closePanel` method is fired',
//          async() => {
//             const wrapper = factoryShallowMount();
...
//         it('should change the `selectedItem` data when the `showDetail` method is fired',
//             async() => {
//             const wrapper = factoryShallowMount();
...
//         it('should add all places to `activePins` when `showAllPlaces` is fired',
//          async() => {
//             const wrapper = factoryShallowMount();
...
// it('should change the `selectedCategory` data when the `setCategory` method is fired',
//          async() => {
//             const wrapper = factoryShallowMount();
...
// it('should add all objects from `placesData` prop to `activePins` when `showAllPlaces` is fired',
//          async() => {
//             const wrapper = factoryShallowMount();
//             wrapper.vm.showAllPlaces();
